...
export default function SelectPodcast(props) {
    const {Forsongtype=false,forSongName=false,forPodName=false,ForPodtype=false,name,image}=props;
            ...
            <div className='wrap'>
                ...
                <div className='cnt-part'>
                    ...
                    <div className='icons Movietype'>
                        ...
                        <span style={{ position: "relative" }} onClick={toggolePop}><i class="fa-solid fa-ellipsis-vertical"></i>
