    ...
    return (
        <>
            <div>
                <div className='hotel_search'>
                    ...
                    <div className='location'>
                        ...
                        <div className='inputBox'>
                            <input type='text' placeholder='London' className='location_name' />
                            <img src={s} />
                    ...
                    <div className='row'>
                        <div className='col-md-6'>
                            <div className='location check_in mt-3 '>
                                <label>Guests</label>
                                <div className='inputBox'>
                                    <h4 onClick={() => setFamily(!family)}>2 Adults | 0 Children</h4>
                                    {family &&
                                        <div className='room_needBox'>
                                            <div className='room_need'>
                                                ...
                                                <div className='d-flex' style={{ gap: '10px' }}>
                                                    <button onClick={decrementCount}><i class="fa-sharp fa-solid fa-minus"></i></button>
                                                    <div className='input_value'>{count}</div>
                                                    <button onClick={incrementCount}><i class="fa-solid fa-plus"></i></button>
                                                </div>
                                            </div>
                        ...
                        <div className='col-md-6'>
                            <div className='location check_in mt-3 '>
                                ...
                                <div className='inputBox'>
                                    ...
                                    {room && <div className='room_needBox'>
                                        <div className='room_need'>
                                            <div>
                                                <h5>Rooms</h5>
                                                <span>(Max  8)</span>
                ...
                <Link to="/hotel-search" className='search_hotel_Btn'>Search Hotel</Link>
